...
\input{sections/rocket}
\input{sections/variants}
\input{sections/experimentation}
\input{sections/results}
\input{sections/conclusions}

% Keep bibliography non-empty while section citations are still being added.
\nocite{bagnall2017bakeoff,dempster2020rocket,middlehurst2024bakeoffredux,aeon,ucr}
