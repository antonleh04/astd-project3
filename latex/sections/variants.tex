...
A combined variant, \textbf{Hydra-MultiROCKET}, concatenates Hydra's histogram features with MultiROCKET's pooling features.
This hybrid achieves the highest mean accuracy in the ROCKET family to date on the UCR archive.
